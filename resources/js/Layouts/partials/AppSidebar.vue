...
const sbroot = () =>
    h(
        'aside',
        {
            ref: target,
            class: [
                'absolute border-r dark:border-r-surface-700 left-0 top-0 z-999 flex bg-surface-50 dark:bg-surface-800 h-screen w-[18rem] flex-col overflow-y-hidden duration-300 ease-linear lg:static lg:translate-x-0',
                {
