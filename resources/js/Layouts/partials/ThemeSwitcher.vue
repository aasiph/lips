...
const updateColors = function (type: string, color: any) {
...
const applyTheme = function (type: string, color: any) {
    if (type === 'primary') {
    ...
    <div class="card flex justify-end p-2">
        <ul class="flex list-none m-0 p-0 gap-2 items-center">
            ...
            <!--            <li class="relative">
                            ...
                            <div
                                class="absolute top-[2.5rem] right-0 hidden w-[16rem] p-3 bg-white dark:bg-surface-800 rounded-md shadow-sm border border-surface-200 dark:border-surface-700 flex-col justify-start items-start gap-3.5 inline-flex origin-top z-10">
                                <div class="flex-col justify-start items-start gap-2 inline-flex pr-4">
                                    <span class="text-xs font-medium">Primary Colors</span>
                                ...
                                <div class="flex-col justify-start items-start gap-2 inline-flex pr-2">
                                    <span class="text-xs font-medium">Surface Colors</span>
