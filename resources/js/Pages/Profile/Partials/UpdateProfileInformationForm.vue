...
<template>
    <section>
        <header>
            ...
            <p class="mt-1 text-xs text-gray-600">Update your account's profile information and email address.</p>
        </header>
            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="text-xs mt-2 text-gray-800">
                    ...
                    <Link
                        ...
                        method="post"
                        as="button"
                        class="underline text-xs text-gray-600 hover:text-gray-900 rounded-md focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
